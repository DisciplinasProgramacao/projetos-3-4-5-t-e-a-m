				...
				case 3:
					try {
						...
						case 1:
							...
							entrada = ler.nextLine();
							novo = new Carro(placa, valorVenda, kmAtual, Carro.combustiveis[Integer.parseInt(entrada)]);
							break;
						...
						case 4:
							...
							entrada = ler.nextLine();
							novo = new Carro(placa, valorVenda, kmAtual, Furgao.combustiveis[Integer.parseInt(entrada)]);
							break;
